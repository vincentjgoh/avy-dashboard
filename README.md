...
avy-dashboard is a simple function (and one defvar) that allows you to jump directly to a file rather than jump to a section and then
...
I recommend binding it to a key like this in the dashboard-mode-map
``` lisp
